...
add_shortcode('tabs_import_cron_accordion_shortcodes', 'tabs_import_cron_accordion_shortcodes');
add_action('tabs_import_cron_accordion_shortcodes', 'tabs_import_cron_accordion_shortcodes');


function tabs_import_cron_accordion_shortcodes(){
    ...
    if ( $wp_query->have_posts() ) :
        while ( $wp_query->have_posts() ) : $wp_query->the_post();
            ...
            if( strpos($post_content, '[accordion') !== false){
                $tabs = tabs_str_between_all($post_content, "[accordion", "[/accordion]");

                if(!empty($tabs))
                foreach ($tabs as $tab_content){

                    $shortcode_content = tabs_nested_shortcode_content($tab_content, $child_tag='accordion-item');
        ...
        wp_clear_scheduled_hook('tabs_import_cron_accordion_shortcodes');
