...
add_shortcode('tabs_import_cron_helpie_faq', 'tabs_import_cron_helpie_faq');
add_action('tabs_import_cron_helpie_faq', 'tabs_import_cron_helpie_faq');


function tabs_import_cron_helpie_faq(){
    ...
    if ( $wp_query->have_posts() ) :
        ...
        wp_clear_scheduled_hook('tabs_import_cron_helpie_faq');
