...
add_shortcode('tabs_import_cron_quick_easy_faqs', 'tabs_import_cron_quick_easy_faqs');
add_action('tabs_import_cron_quick_easy_faqs', 'tabs_import_cron_quick_easy_faqs');


function tabs_import_cron_quick_easy_faqs(){
    ...
    if ( $wp_query->have_posts() ) :
        ...
        wp_clear_scheduled_hook('tabs_import_cron_quick_easy_faqs');
