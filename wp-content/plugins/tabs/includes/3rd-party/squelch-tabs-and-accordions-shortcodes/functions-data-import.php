...
add_shortcode('tabs_import_cron_squelch_tabs_tabs', 'tabs_import_cron_squelch_tabs_tabs');
add_action('tabs_import_cron_squelch_tabs_tabs', 'tabs_import_cron_squelch_tabs_tabs');


function tabs_import_cron_squelch_tabs_tabs(){
    ...
    if ( $wp_query->have_posts() ) :
        while ( $wp_query->have_posts() ) : $wp_query->the_post();
            ...
            if( strpos($post_content, '[tabs') !== false){
                ...
                foreach ($tabs as $tab_content){
                    ...
                    $shortcode_content = tabs_nested_shortcode_content($tab_content, $child_tag='accordion');
            ...
            if( strpos($post_content, '[htabs') !== false){
                $tabs = tabs_str_between_all($post_content, "[htabs", "[/htabs]");

                if(!empty($tabs))
                    foreach ($tabs as $tab_content){

                        $shortcode_content = tabs_nested_shortcode_content($tab_content, $child_tag='haccordion');
        ...
        wp_clear_scheduled_hook('tabs_import_cron_squelch_tabs_tabs');
