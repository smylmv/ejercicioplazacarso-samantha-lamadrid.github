...
add_shortcode('tabs_import_cron_tabby_responsive_tabs', 'tabs_import_cron_tabby_responsive_tabs');
add_action('tabs_import_cron_tabby_responsive_tabs', 'tabs_import_cron_tabby_responsive_tabs');


function tabs_import_cron_tabby_responsive_tabs(){
    ...
    if ( $wp_query->have_posts() ) :
        while ( $wp_query->have_posts() ) : $wp_query->the_post();
            ...
            if( strpos($post_content, '[tabbyending') !== false){
                $tabs = tabs_str_between_all($post_content, "[tabby", "[tabbyending]");
                ...
                foreach ($tabs as $tab_content){
                    ...
                    //$shortcode_content = tabs_nested_shortcode_content($tab_content, $child_tag='tabby');
        ...
        wp_clear_scheduled_hook('tabs_import_cron_tabby_responsive_tabs');
