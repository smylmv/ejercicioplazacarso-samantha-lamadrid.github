...
add_shortcode('tabs_import_cron_tabs_shortcode', 'tabs_import_cron_tabs_shortcode');
add_action('tabs_import_cron_tabs_shortcode', 'tabs_import_cron_tabs_shortcode');


function tabs_import_cron_tabs_shortcode(){
    ...
    if ( $wp_query->have_posts() ) :
        ...
        wp_clear_scheduled_hook('tabs_import_cron_tabs_shortcode');
